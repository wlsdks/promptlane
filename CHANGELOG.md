...
- Quality evidence separates repeatable isolated release proof from optional
  fail-closed live Codex or Claude Code runtime verification.
...
- Installed `looprelay benchmark` command with synthetic/real fixture
  ...
  derives both tool catalogue and dispatch from definition/handler pairs.
