...
| `corepack pnpm pack:dry-run` | PASS | Built server and web assets, ran the package dry-run wrapper, and produced `prompt-coach-0.1.0-beta.0.tgz` with 343 files. |

## CI

- main CI run `28750424030` passed `test (22)` and `test (24)`.
