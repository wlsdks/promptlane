...
prompt-coach:record_agent_judgments
```
...
Do not call external providers through prompt-coach. Do not ask for provider
...
`prompt-coach mcp` server. Do not emulate it by manually reading Markdown
