            ...
            {worktreeDetail.selected_brief_action && (
              <div className="loop-detail-section">
                ...
                {worktreeDetail.continuation_safety_post_memory_approval_retry_renewed_memory_approval_post_submit_collection_retry_boundary_note && (
                  <LoopReviewItem
                    footer="No post-memory-approval retry renewed-memory-approval post-submit collection retry writes or external calls"
                    lines={[
                      worktreeDetail
                ...
                {worktreeDetail.continuation_safety_post_memory_approval_retry_renewed_memory_approval_post_submit_retry_outcome_non_persistence_note && (
                  <LoopReviewItem
                    footer="No post-memory-approval retry renewed-memory-approval post-submit retry outcome persistence writes or external calls"
                    lines={[
                      worktreeDetail
                ...
                {worktreeDetail.continuation_safety_post_memory_approval_retry_renewed_memory_approval_post_submit_retry_evidence_freshness_boundary_note && (
                  <LoopReviewItem
                    footer="No post-memory-approval retry renewed-memory-approval post-submit retry evidence freshness verification writes or external calls"
                    lines={[
                      worktreeDetail
                ...
                {worktreeDetail.continuation_safety_post_memory_approval_retry_renewed_memory_approval_post_submit_retry_freshness_result_non_persistence_note && (
                  <LoopReviewItem
                    footer="No post-memory-approval retry renewed-memory-approval post-submit retry freshness result persistence writes or external calls"
                    lines={[
                      worktreeDetail
                ...
                {worktreeDetail.continuation_safety_post_memory_approval_retry_renewed_memory_approval_post_submit_retry_freshness_uncertainty_collection_reminder && (
                  <LoopReviewItem
                    footer="No post-memory-approval retry renewed-memory-approval post-submit retry freshness uncertainty collection writes or external calls"
                    lines={[
                      worktreeDetail
                ...
                {worktreeDetail.continuation_safety_post_memory_approval_retry_renewed_memory_approval_post_submit_retry_pre_memory_approval_freshness_advisory && (
                  <LoopReviewItem
                    footer="No post-memory-approval retry renewed-memory-approval post-submit retry pre-memory-approval freshness advisory writes or external calls"
                    lines={[
                      worktreeDetail
                ...
                {worktreeDetail.continuation_safety_post_memory_approval_retry_renewed_memory_approval_post_submit_retry_renewed_memory_approval_pre_handoff_freshness_advisory && (
                  <LoopReviewItem
                    footer="No post-memory-approval retry renewed-memory-approval post-submit retry renewed-memory-approval pre-handoff freshness advisory writes or external calls"
                    lines={[
                      worktreeDetail
                ...
                {worktreeDetail.continuation_safety_post_memory_approval_retry_renewed_memory_approval_post_submit_retry_renewed_memory_approval_pre_paste_freshness_advisory && (
                  <LoopReviewItem
                    footer="No post-memory-approval retry renewed-memory-approval post-submit retry renewed-memory-approval pre-paste freshness advisory writes or external calls"
                    lines={[
                      worktreeDetail
                ...
                {worktreeDetail.continuation_safety_post_memory_approval_retry_renewed_memory_approval_post_submit_retry_renewed_memory_approval_pre_submit_freshness_advisory && (
                  <LoopReviewItem
                    footer="No post-memory-approval retry renewed-memory-approval post-submit retry renewed-memory-approval pre-submit freshness advisory writes or external calls"
                    lines={[
                        worktreeDetail
